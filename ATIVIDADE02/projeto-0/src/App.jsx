  ...
  return (
    <>
      ...
      <form id="meu-formulario">
        ...
        <input type="text" name="nome" id="nome_aluno" placeholder="Digite seu nome completo" />
        <button type="button" id="btn_nome">Enviar</button>
...
=======
        ...
        <input type="number" name="matricula" id="matricula_aluno" placeholder="Digite sua matrícula" />
        <button type="button" id="btn_matricula">Enviar</button>
      </form>
      ...
      <div id='q1'>
        ...
        <ul>
          <li id="a1">
            <input type="radio" name="questao1" id="alternativas_a1" value="400" />
            <label htmlFor="alternativas_a1">A) 400</label>
          </li>
          <li id="b2">
            <input type="radio" name="questao1" id="alternativas_b2" value="300" />
            <label htmlFor="alternativas_b2">B) 300</label>
          </li>
          <li id="c1">
            <input type="radio" name="questao1" id="alternativas_c1" value="324" />
            <label htmlFor="alternativas_c1">C) 324</label>
          </li>
          <li id="d1">
            <input type="radio" name="questao1" id="alternativas_d1" value="298" />
>>>>>>> 4755994435c594783a46dab12668c63dfcecedb7
...
=======
      <div id='q2'>
        ...
        <ul>
          <li id="a2">
            <input type="radio" name="questao2" id="alternativa_a2" value="li" />
            <label htmlFor="alternativa_a2">A) li</label>
          </li>
          <li id="b2">
            <input type="radio" name="questao2" id="alternativa_b2" value="ul" />
            <label htmlFor="alternativa_b2">B) ul</label>
          </li>
          <li id="c2">
            <input type="radio" name="questao2" id="alternativa_c2" value="ol" />
            <label htmlFor="alternativa_c2">C) ol</label>
          </li>
          <li id="d2">
            <input type="radio" name="questao2" id="alternativa_d2" value="nl" />
>>>>>>> 4755994435c594783a46dab12668c63dfcecedb7
...
=======
      <div id='q3'>
        ...
        <ul>
          <li id="a3">
            <input type="radio" name="questao3" id="alternativa_a3" value="asia" />
            <label htmlFor="alternativa_a3">A) Ásia</label>
          </li>
          <li id="b3">
            <input type="radio" name="questao3" id="alternativa_b3" value="africa" />
            <label htmlFor="alternativa_b3">B) África</label>
          </li>
          <li id="c4">
            <input type="radio" name="questao3" id="alternativa_c4" value="europa" />
            <label htmlFor="alternativa_c4">C) Europa</label>
          </li>
          <li id="d4">
            <input type="radio" name="questao3" id="alternativa_d4" value="americaDoSul" />
