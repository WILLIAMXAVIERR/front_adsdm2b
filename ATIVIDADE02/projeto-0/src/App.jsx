...
function App() {
  ...
  return (
    <>
      ...
      <div className='multipla_escolha'>
        <p className='titulo'>
          Questão 2 - Qual tag é numera uma lista?
        </p>
        <ul>
          <li>
      ...
      <div class='multipla_escolha'>
        ...
        <ul>
          ...
          <li>
            <input type="radio" name="questao3" id="alternativa_b4" value="europa" />
            <label htmlFor="europa">C) Europa</label>
          </li>
          <li>
            <input type="radio" name="questao3" id="alternativa" value="americaDoSul" />
